...
bot = telebot.TeleBot(token='7073439978:AAE5Fb3Gft9R1fUKvoHQ6tcWJX-0j9PaJ14')
name = None
...
#     markup = types.InlineKeyboardMarkup()
#     btn1 = types.InlineKeyboardButton('Перейти на сайт', url="https://telegra.ph/file")
#     markup.row(btn1)
#     btn2 = types.InlineKeyboardButton('Удалить фото', callback_data="delete")
#     btn3 = types.InlineKeyboardButton('Изменить текст', callback_data="edit")
#     markup.row(btn2,btn3)
#     # markup.add(types.InlineKeyboardButton('Перейти на сайт', url='https://www.youtube.com/watch?v='))
